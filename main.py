...
for Y in range(2013, 2024):  # From 2013 to 2024
...
plt.title("Carbon Footprint and WACI for P_mv_oos (2013–2024)")
plt.xlabel("Year")
...
plt.title("Carbon Footprint Comparison (2013–2024)")
plt.xlabel("Year")
...
for Y in range(2013, 2024):  # From 2013 to 2024, using weights from Y-1 for year Y
...
if carbon_footprints_nz:
    ...
    plt.title("NZ Portfolio Carbon Footprint vs Targets (2013–2024)")
    plt.xlabel("Year")
    plt.ylabel("Carbon Footprint (tons CO2e per million USD)")
    plt.grid(True)
    plt.legend()
